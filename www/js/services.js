...
angular.module('xinrenshe.services', []).factory('Common', [
    ...
    function($ionicPopup, $ionicHistory, $cacheFactory, $ionicLoading, $http, $location, md5, $ionicActionSheet) {
        ...
        offline = true;
        apiBaseUrl = offline ? 'http://appdev.xinrenclub.com/v1.3/' : 'http://api.xinrenclub.com/v1.3/';
        ...
        return {
            API: {
                ...
                savePostcardConf: apiBaseUrl + 'setUserConf/savePostcardConf',
                postcardConf: apiBaseUrl + 'setUserConf/postcardConf',
